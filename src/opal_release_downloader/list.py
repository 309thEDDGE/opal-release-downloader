...
def list_bucket_objects(
    bucket_name: str, *, prefix: str = "", region_name: str = DEFAULT_REGION
) -> dict:
...
def get_all(bucket_name, *, prefix="", region_name=DEFAULT_REGION):
    obj_list = list_bucket_objects(bucket_name, prefix=prefix, region_name=region_name)
    return obj_list
...
def main():
    ...
    parser.add_argument(
        "--all", "-a", help="show all", action="store_true", default=False
    )
